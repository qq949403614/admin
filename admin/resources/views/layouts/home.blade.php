...
<link href="/jiuyexiangmu/home/assets/css/bootstrap-1.css" rel='stylesheet' type='text/css' />
			...
			<div class="col-md-6">
				<div class="top-header-left">
					<ul>
						<li>
							<div class="dropdown">
								<a href="#" class="btn btn-default dropdown-toggle" data-toggle="dropdown" data-hover="dropdown">
								  complex <i class="fa fa-angle-down" aria-hidden="true"></i>
								</a>
						...
						<li>
							<span><a href="#" class="btn btn-default dropdown-toggle" data-toggle="dropdown" data-hover="dropdown">Hello Custumer - Login or Registe!</a></span>
					...
					<ul>
						...
						<li>
							<div class="dropdown">
								...
								<ul class="dropdown-menu dropdownhover-bottom" style="left: -34.7813px; right: auto;">
...
<div style="background:#ccc; height:2px; width:1130px; margin-left:100px;"></div>
<footer>
	<div class="container">
		<div class="row">
